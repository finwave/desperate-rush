...
float CGameSettings::GAME_STATE_SPEED_CHANGE_DURATION = 0.5f;
float CGameSettings::SCROLLING_PLAYER_VELOCITY_MAX = 130.0f;

float CGameSettings::SCROLLING_BACKGROUND_TOP_MIN_BOSS = 1.0f;
float CGameSettings::SCROLLING_BACKGROUND_TOP_MIN = 4.0f;
float CGameSettings::SCROLLING_BACKGROUND_TOP_MAX = 12.0f;
...
int CGameSettings::ENEMY_BOSS_FRAME_HEALTH = 2100;
